...
<div class="max-w-2xl mx-auto">
    <div class="card">
        <form method="POST" action="{{ route('site-owner.sites.update', $site) }}">
            @csrf
            @method('PUT')
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <span class="font-medium text-orange-600 ml-2">{{ substr($site->api_key, 0, 10) }}...</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>L'API Key rimane invariata e non può essere modificata. Solo il nome e l'URL del sito possono essere aggiornati.</p>
                            </div>
                        </div>
                    </div>
                </div>
