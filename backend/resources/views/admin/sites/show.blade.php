...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('admin.sites.edit-info', $site) }}" class="btn-secondary">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="card">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('admin.sites.edit-info', $site) }}" class="text-orange-600 hover:text-orange-700 text-sm font-medium">
                Modifica
            </a>
        </div>
    ...
    <div class="card border-gray-200 bg-gray-50">
        <div class="text-center py-8">
            ...
            <p class="text-gray-500 mb-4">Aggiungi informazioni aziendali per questo sito</p>
            <a href="{{ route('admin.sites.edit-info', $site) }}" class="btn-primary">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
